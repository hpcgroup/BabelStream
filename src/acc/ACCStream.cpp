...
void ACCStream<T>::init_arrays(T initA, T initB, T initC)
{
    ...
    T * restrict b = this->b;
    T * restrict c = this->c;
    #pragma acc parallel loop present(a[0:array_size], b[0:array_size], c[0:array_size])
...
void ACCStream<T>::copy()
{
    ...
    T * restrict a = this->a;
    T * restrict c = this->c;
    #pragma acc parallel loop independent present(a[0:array_size], c[0:array_size])
    for (int i = 0; i < array_size; i++)
    {
        #pragma acc atomic
        c[i] = a[i];
...
void ACCStream<T>::mul()
{
    ...
    T * restrict b = this->b;
    T * restrict c = this->c;
    #pragma acc parallel loop independent present(b[0:array_size], c[0:array_size])
    for (int i = 0; i < array_size; i++)
    {
        #pragma acc atomic
        b[i] = scalar * c[i];
...
void ACCStream<T>::add()
{
    ...
    T * restrict b = this->b;
    T * restrict c = this->c;
    #pragma acc parallel loop independent present(a[0:array_size], b[0:array_size], c[0:array_size])
    for (int i = 0; i < array_size; i++)
    {
        #pragma acc atomic
        c[i] = a[i] + b[i];
...
void ACCStream<T>::nstream()
{
    ...
    T * restrict b = this->b;
    T * restrict c = this->c;
    #pragma acc parallel loop independent present(a[0:array_size],  b[0:array_size], c[0:array_size]) wait
    for (int i = 0; i < array_size; i++)
    {
        #pragma acc atomic
        a[i] += b[i] + scalar * c[i];
...
T ACCStream<T>::dot()
{
    ...
    T * restrict a = this->a;
    T * restrict b = this->b;
    #pragma acc parallel loop independent reduction(+:sum) present(a[0:array_size], b[0:array_size])
    for (int i = 0; i < array_size; i++)
    {
        sum += a[i] * b[i];
    }
